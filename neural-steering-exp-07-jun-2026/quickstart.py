...
normal   = steerer.generate(test_prompt, max_new_tokens=512)
ablated  = steerer.steer(test_prompt, feature="refusal", multiplier=0.0, max_new_tokens=512)
amplified = steerer.steer(test_prompt, feature="refusal", multiplier=3.0, max_new_tokens=512)
