...
#
# Optional model override (quickstart.py currently hardcodes the model):
#   MODEL=Qwen/Qwen2.5-7B-Instruct sbatch submit_quickstart.sh
#   sbatch submit_quickstart.sh Qwen/Qwen2.5-7B-Instruct
...
echo "Model:     ${MODEL}"
echo ""
echo "NOTE: quickstart.py hardcodes meta-llama/Llama-3.1-8B-Instruct;"
echo "      the MODEL override above is informational until quickstart.py accepts it."
echo ""
