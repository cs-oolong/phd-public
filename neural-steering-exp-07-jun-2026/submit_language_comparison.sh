#!/bin/bash
# Usage:
#   sbatch submit_language_comparison.sh
#   sbatch submit_language_comparison.sh Qwen/Qwen2.5-7B-Instruct
#   # Check output:
#   tail -f /home/ana.serpa/slurm/<jobid>.out

#SBATCH --job-name=language_cmp
...
echo "=== Running language_comparison.py ==="
$PYTHON -u language_comparison.py --model "${MODEL}"
