#!/bin/bash
# Usage:
#   sbatch submit_entity_comparison.sh
#   sbatch submit_entity_comparison.sh Qwen/Qwen2.5-7B-Instruct
#   # Check output:
#   tail -f /home/ana.serpa/slurm/<jobid>.out

#SBATCH --job-name=entity-cmp
...
echo "=== Running entity_comparison.py ==="
$PYTHON -u entity_comparison.py --model "${MODEL}"
