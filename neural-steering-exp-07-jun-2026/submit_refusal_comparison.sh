#!/bin/bash
# Usage:
#   sbatch submit_refusal_comparison.sh
#   sbatch submit_refusal_comparison.sh Qwen/Qwen2.5-7B-Instruct
#   # Check output:
#   tail -f /home/ana.serpa/slurm/<jobid>.out

#SBATCH --job-name=refusal_cmp
...
echo "=== Running refusal_comparison.py ==="
$PYTHON -u refusal_comparison.py --model "${MODEL}"
