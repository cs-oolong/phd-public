...
EXECUTION_METADATA = {
    "script_version": "4.1-Llama8B-4bit",
...
# =============================================================================
# CARREGAR MODELO COM QUANTIZACAO 4-BIT
# =============================================================================
...
# Configuracao 4-bit
print("\nConfigurando quantizacao 4-bit...")
...
print(f"\nCarregando modelo: {MODEL_NAME} (4-bit)...")
...
print(f"Modelo carregado em 4-bit!")
print(f"VRAM usada: {torch.cuda.memory_allocated() / 1024**3:.1f} GB")
print(f"VRAM reservada: {torch.cuda.memory_reserved() / 1024**3:.1f} GB")
